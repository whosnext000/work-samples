...
require_once( $parse_uri[0] . 'wp-load.php' ); 
	...
	$loop = new WP_Query($args); 
	 ?>
		...
		$hotels = get_the_terms($product->id, 'pa_hotel'); 
		...
		<div class="popup myriadGlobal packages <?php echo $product->get_attribute( 'section' ); ?> sct-<?php echo $product->get_attribute( 'section' ); ?>" >
			...
			<!-- Get the galleries for each product -->
			  ...
			  <div class="wrapper">
			    <div class="col_two">
				      ...
				      if($variable_products){
						foreach ($product_variations as $variation) {
						    ...
						    //var_dump($variation['variation_id']);
						   	//var_dump($row);
						    echo '<span title="' . $product_price . '" class="variation-price '.$product_variation_id.'" style="display: none;">$' . $product_price . '</span>';
						    //var_dump($is_active);
						}
					}
						?></p>
			      ...
			      <!--<button type="submit" class="scndBtn <?php /*echo $product->get_attribute( 'section' ); ?> <?php foreach ($categories as $category) {
				      	$cat_id = $category->slug;
				      	echo $cat_id;
				      	break;
				      } ?>">Show all <small><?php foreach ($categories as $category) {
				      	$cat_id = $category->name;
				      	echo $cat_id;
				      	break;
